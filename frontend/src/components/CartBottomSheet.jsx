...
const CartBottomSheet = () => {
  ...
  return (
    <div className="fixed bottom-[85px] lg:bottom-4 left-4 right-4 lg:left-auto lg:w-[400px] z-[45] bg-[#fa6830] rounded-2xl shadow-xl p-4 flex items-center justify-between cursor-pointer hover:bg-[#e55923] transition-colors animate-slide-up" onClick={() => navigate('/user/cart')}>
